...
const Map<String, String> _denominationContext = {
  'Baptist': '''
...
String _buildSystemPrompt(String? denomination) {
  ...
  return _baseSystemPrompt + context;
}
...
class ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  Future<String> _streamAnthropicApi({
    ...
    try {
      ...
      final historyToSend = _conversationHistory.length > 20
