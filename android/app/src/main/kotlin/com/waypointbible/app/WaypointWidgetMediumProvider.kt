...
class WaypointWidgetMediumProvider : HomeWidgetProvider() {
    ...
    private fun updateWidget(
        ...
        views.setTextViewText(R.id.streak_label, formatStreak(streak))
    ...
    private fun formatStreak(streak: Int): String = when (streak) {
